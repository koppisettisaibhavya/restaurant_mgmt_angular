...
@Component({
  selector: 'app-meal1',
  templateUrl: './meal1.component.html',
  styleUrls: ['./meal1.component.css']
})
export class Meal1Component implements OnInit {
  ...
  ngOnInit(): void {
    this.userserv.getdata("Meals").subscribe((data:Array<Upload>) => {
      this.item_list = data
      console.log(data);
     })
  }
